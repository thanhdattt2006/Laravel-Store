...
<html lang="en">
  <head>
    ...
    <!-- CSS elementCss -->
    <link rel="stylesheet" href="{{asset('admin')}}/assets/css/elementCss/style.css">
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="sidebarLayouts">
                  <ul class="nav nav-collapse">
                    ...
                    <li>
                      <a href="{{url('admin/allCategories')}}">
