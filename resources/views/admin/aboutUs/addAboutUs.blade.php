...
<div class="container">
    <div class="page-inner">
        <form action="{{url(('admin/saveAboutUs'))}}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <a href="{{url('admin/aboutus')}}"><button type="button" class="btn btn-danger">Cancel</button></a>
                        </div>
                        </div>
                    </div>
                </div>
