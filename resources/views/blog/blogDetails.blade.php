	                ...
	                <div class="single-post row">
	                    <div class="col-lg-12">
	                        <div class="feature-img">
	                            <img class="img-fluid" src="{{asset('user')}}/img/blog/feature-img1.jpg" alt="">
	                        </div>
	                    </div>
	                    ...
	                    <div class="col-lg-12">
	                        ...
	                        <div class="row">
	                            <div class="col-6">
	                                <img class="img-fluid" src="{{asset('user')}}/img/blog/post-img1.jpg" alt="">
	                            </div>
	                            <div class="col-6">
	                                <img class="img-fluid" src="{{asset('user')}}/img/blog/post-img2.jpg" alt="">
	                            </div>
